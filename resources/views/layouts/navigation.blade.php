            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('admin.crops.index')" :active="request()->routeIs('admin.crops.*')">
                            {{ __('Crops') }}
                        </x-nav-link>
                        <x-nav-link :href="route('admin.fertilizers.index')" :active="request()->routeIs('admin.fertilizers.*')">
                            {{ __('Fertilizers') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.crops.index')" :active="request()->routeIs('admin.crops.*')">
                    {{ __('Crops') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.fertilizers.index')" :active="request()->routeIs('admin.fertilizers.*')">
                    {{ __('Fertilizers') }}
                </x-responsive-nav-link>
